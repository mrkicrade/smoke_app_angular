...
.controller('homeCtrl' , function(){
    ...
    let newCigarBtn = document.querySelector('.newCigar');
    ...
    newCigarBtn.addEventListener('click' , newCigar);
    ...
    function newWeek() {
        if (currentDay == 'Monday') {
            ...
            mon = parseInt(localStorage.getItem('Monday'));
            tue = parseInt(localStorage.getItem('Tuesday'));
            thu = parseInt(localStorage.getItem('Thursday'));
            wed = parseInt(localStorage.getItem('Wednesday'));
            fri = parseInt(localStorage.getItem('Friday'));
            sat = parseInt(localStorage.getItem('Saturday'));
            sun = parseInt(localStorage.getItem('Sunday'));
            reset();
        } else {
